...
fun PayTypesScreen(
            ...
            confirmButton = {
                Button(onClick = {
                    if (editTypeName.isNotEmpty()) {
                        expenseViewModel.updatePayType(
    ...
    if (showDeleteDialog) {
        androidx.compose.material3.AlertDialog(
            ...
            text = { Text(text = "确定要删除此支付类型吗？") },
            confirmButton = {
                TextButton(onClick = {
                    expenseViewModel.deletePayType(
